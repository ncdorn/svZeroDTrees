...
def simdir_from_mesh(mesh_complete, threed_dir, zerod_dir):
    '''
    ...
    :param zerod_dir: path to zerod simulation directory with zerod model and clinical targets'''
    ...
    setup_simdir_from_mesh(threed_dir, zerod_config)
