...
def test_solver_runscript_writes_stage_local_log_paths_and_working_dir(tmp_path: Path):
    ...
    runscript.write(nodes=2, procs_per_node=8, hours=4, memory=12, working_dir=str(tmp_path))
    ...
    assert "srun /home/users/ndorn/svMP-build/svMultiPhysics-build/bin/svmultiphysics svFSIplus.xml" in rendered
