...
- Prefer focused unit tests and package-level integration tests. Classify tests into unit, integration, and end-to-end categories and avoid blurring those lines.
